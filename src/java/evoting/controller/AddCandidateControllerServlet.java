    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(candidate!=null && candidate.equals("getid"))
        {
            try
            {
                ...
                pw.println(cid);  //although we could've made a separate jsp but it doesen't make sense to 
                                  //create a separate jsp for such small task,also we're not following strict MVC
                return; 
            }
