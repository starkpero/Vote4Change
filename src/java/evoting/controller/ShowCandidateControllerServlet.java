    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            if(data!=null && data.equalsIgnoreCase("cid"))
            {
                ...
                System.out.println("candidateList in ShowCandidateServlet"+candidateList);
                request.setAttribute("candidateid", candidateList);     //ArrayList
                request.setAttribute("result", "candidatelist") ;    //This will help jsp to identify that whether it has 
                                                                    //been sent ArrayList or DTO object
            }
            else
            {
                CandidateDetails cd = CandidateDAO.getDetailsById(data);
                request.setAttribute("candidate", cd);     //ArrayList
